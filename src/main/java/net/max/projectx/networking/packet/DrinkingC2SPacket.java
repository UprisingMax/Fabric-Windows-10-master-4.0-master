package net.max.projectx.networking.packet;
...
public class DrinkingC2SPacket {
    private static final String MESSAGE_DRINKING_WATER = null;
    private static final String MESSAGE_NO_WATER_NEARBY = "message.projectx.no_water";
